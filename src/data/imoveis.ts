...
export type TipoEspaco = "Comercial" | "Sala Comercial";
...
export const imoveis: Imovel[] = [
  ...
  {
    id: "abc-3",
    titulo: "Galpão Comercial - São Caetano do Sul",
    tipo: "Venda",
    espaco: "Comercial",
    regiao: "ABC Paulista",
    cidade: "São Caetano do Sul",
    bairro: "Santa Paula",
    endereco: "Rua Manoel Coelho, 320",
    area: 350,
    preco: 1200000,
    banheiros: 4,
    vagas: 6,
    comPonto: false,
    descricao: "Galpão comercial de 350m² em região industrial valorizada. Pé direito alto, docas para carga e descarga, escritório administrativo.",
    descricaoCompleta: "Galpão comercial de 350m² em São Caetano do Sul, cidade com excelente infraestrutura e localização estratégica no ABC. Pé direito de 8 metros, 2 docas para carga e descarga, escritório administrativo de 60m² com ar-condicionado, 4 banheiros (incluindo vestiário), piso industrial de alta resistência e instalação elétrica trifásica. Estacionamento para 6 veículos. Ideal para logística, depósito, fábrica ou centro de distribuição. Documentação regularizada.",
    imagem: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=600&h=400&fit=crop",
    responsavel: {
      nome: "Fernanda Costa",
    ...
    caracteristicas: ["Pé direito 8m", "2 docas", "Escritório admin", "Piso industrial", "Elétrica trifásica", "6 vagas"],
  },
  {
    id: "abc-4",
  ...
  {
    id: "lit-3",
    titulo: "Loja Comercial na Orla - Praia Grande",
    tipo: "Venda",
    espaco: "Comercial",
    regiao: "Litoral Paulista",
    cidade: "Praia Grande",
    bairro: "Guilhermina",
    endereco: "Av. Presidente Kennedy, 4500",
    area: 90,
    preco: 480000,
    banheiros: 2,
    vagas: 2,
    comPonto: false,
    descricao: "Loja comercial de 90m² na avenida principal da Guilhermina, alto fluxo de turistas. Ideal para restaurante, loja de conveniência ou franquia.",
    descricaoCompleta: "Loja comercial de 90m² na Av. Presidente Kennedy, principal via da praia da Guilhermina em Praia Grande. Fachada ampla com 8 metros de frente, vitrine em vidro temperado, 2 banheiros, copa e depósito. Instalação elétrica preparada para equipamentos de cozinha industrial. Alto fluxo de turistas durante todo o ano, com pico na temporada de verão. 2 vagas de estacionamento. Zoneamento permite uso gastronômico, varejo e serviços. Documentação regularizada e pronta para transferência.",
    imagem: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=600&h=400&fit=crop",
    responsavel: {
    ...
    caracteristicas: ["Frente de 8m", "Vitrine em vidro", "Cozinha industrial", "Alto fluxo turístico", "2 vagas"],
  },
  {
    id: "lit-4",
